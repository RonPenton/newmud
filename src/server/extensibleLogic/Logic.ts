...
export type LogicParameters = ObjectDescriptor;
export type LogicReturn = ObjectDescriptor | TypeDescriptor<any>;
...
> = {
    ...
    parameters: P, 
    result: R,
    defaultValue: (params: InferProxyObject<P>) => InferStorageDescriptor<R>
};
